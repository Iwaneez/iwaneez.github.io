...
import com.iwaneez.stuffer.core.event.BusEvent;
...
import com.iwaneez.stuffer.core.ui.view.AccessDeniedView;
import com.iwaneez.stuffer.core.ui.view.ErrorView;
import com.iwaneez.stuffer.core.ui.view.LoginView;
import com.iwaneez.stuffer.core.ui.view.MainView;
import com.iwaneez.stuffer.core.util.Localization;
import com.iwaneez.stuffer.core.util.SessionScopedEventBus;
    ...
    private void setupNavigator(SpringNavigator springNavigator) {
        ...
        springNavigator.addViewChangeListener(new ViewChangeListener() {
            ...
            public void afterViewChange(ViewChangeEvent event) {
                SessionScopedEventBus.post(new BusEvent.ViewChangedEvent(MenuItem.getByViewName(event.getViewName())));
            }
        });
    }
