...
public interface PersonRepository extends JpaRepository<Person, Long> {
	...
	/**
	 * This function calls a named query in META-INF/orm.xml with name Person.findByName
	 * @param firstName
	 * @param lastName
	 * @return	A list of persons whose last name and first name are an exact match with the given parameters.
